# EXPERIMENT 05  SOILM MOISTURE SENSOR INTERFACE TO IOT DEVELOPMENT BOARD
## Aim: 
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  soilmoist_percentage = 100 - (readvalue / 40.96);
...
<img width="1241" height="1600" alt="image" src="https://github.com/user-attachments/assets/9e8504a1-28be-4b89-a2fb-7d3717a9c18b" />
